...
def get_config():
    ...
    #
    # # === 新增修改开始 ===
    # # 1. 核心任务奖励：PickScore (图文匹配)
    # config.reward_fn.pickscore = 1.0
    #
    # # 2. 辅助奖励：Aesthetic Score (美学评分)
    # # 这里的权重 0.5 意味着在 GRPO 中它的分值贡献减半；
    # # 在 GDPO 中，意味着它的 Normalized Advantage 会乘以 0.5。
    # config.reward_fn.aesthetic = 0.5
    # # === 新增修改结束 ===
    #
    # config.save_dir = ''
