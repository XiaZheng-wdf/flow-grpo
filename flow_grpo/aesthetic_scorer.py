...
class AestheticScorer(torch.nn.Module):
    def __init__(self, dtype):
        super().__init__()
        self.clip = CLIPModel.from_pretrained("/data1/xiazheng/flow_grpo/models/clip-vit-large-patch14")
        self.processor = CLIPProcessor.from_pretrained("/data1/xiazheng/flow_grpo/models/clip-vit-large-patch14")
        self.mlp = MLP()
